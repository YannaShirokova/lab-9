...
results_enframe |>
  ...
  pivot_wider(names_from = ncorrect, values_from = proportion, names_prefix = "Corrcet ") |>
  kable() |>
...
results_enframe |>
  ...
  labs(x = "", 
       y = "",
       fill = "Correct Babies", 
       subtitle = "Proportion of 10,000 Simulations where Babies are Correctly Returned",
       title = "Four Babies Born: Are They Returned to Correct Parents?") +
  theme_minimal() +
